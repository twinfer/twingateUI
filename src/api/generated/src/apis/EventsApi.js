...
var EventsApi = /** @class */ (function (_super) {
     ...
     * Subscribe to events
     */
    EventsApi.prototype.apiThingsIdEventsNameGetRaw = function (requestParameters, initOverrides) {
                ...
                switch (_c.label) {
                    case 0:
                        if (requestParameters['id'] == null) {
                            throw new runtime.RequiredError('id', 'Required parameter "id" was null or undefined when calling apiThingsIdEventsNameGet().');
                        }
                        if (requestParameters['name'] == null) {
                            throw new runtime.RequiredError('name', 'Required parameter "name" was null or undefined when calling apiThingsIdEventsNameGet().');
                        }
                        queryParameters = {};
                    ...
                    case 2: return [4 /*yield*/, this.request({
                            path: "/api/things/{id}/events/{name}".replace("{".concat("id", "}"), encodeURIComponent(String(requestParameters['id']))).replace("{".concat("name", "}"), encodeURIComponent(String(requestParameters['name']))),
                            method: 'GET',
     ...
     * Subscribe to events
     */
    EventsApi.prototype.apiThingsIdEventsNameGet = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.apiThingsIdEventsNameGetRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
