 ...
 */
export function instanceOfWotDataSchema(value) {
    return true;
}
export function WotDataSchemaFromJSON(json) {
    return WotDataSchemaFromJSONTyped(json, false);
}
export function WotDataSchemaFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function WotDataSchemaToJSON(json) {
    return WotDataSchemaToJSONTyped(json, false);
}
export function WotDataSchemaToJSONTyped(value, ignoreDiscriminator) {
